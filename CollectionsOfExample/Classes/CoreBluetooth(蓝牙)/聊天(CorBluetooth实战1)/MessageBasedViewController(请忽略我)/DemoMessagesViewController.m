...
- (void)viewDidLoad
{
    ...
    activityIndicatorView.frame = CGRectMake(0, 0, 49, 49);
...
- (void)receiveMessage:(NSString *)message senderId:(NSString *)senderId senderName:(NSString *)senderName {
     ...
     *  Copy last sent message, this will be the new "received" message
     */
    JSQMessage *msg = [[JSQMessage alloc] initWithSenderId:senderId senderDisplayName:kJSQDemoAvatarDisplayNameCook date:[NSDate date] text:message];
