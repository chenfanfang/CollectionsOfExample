...
- (void)loadFakeMessages
{
    ...
    self.messages = [[NSMutableArray alloc] initWithObjects:
                     ...
                     [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIdWoz
                                        senderDisplayName:kJSQDemoAvatarDisplayNameWoz
                                                     ...
                                                     text:NSLocalizedString(@"我是假数据，请忽略我.", nil)],
    ...
    JSQMessage* message = [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIdWoz
                       senderDisplayName:kJSQDemoAvatarDisplayNameWoz
                                    date:[NSDate date]
                                                          text:NSLocalizedString(@"我和上面的数据都是假数据，请忽略我们", nil)];
...
- (void)addPhotoMediaMessage
{
    ...
    JSQMessage *photoMessage = [JSQMessage messageWithSenderId:kJSQDemoAvatarIdCook
...
- (void)addLocationMediaMessageCompletion:(JSQLocationMediaItemCompletionBlock)completion
{
    ...
    JSQMessage *locationMessage = [JSQMessage messageWithSenderId:kJSQDemoAvatarIdCook
                                                      displayName:kJSQDemoAvatarDisplayNameCook
                                                            media:locationItem];
...
- (void)addVideoMediaMessage
{
    ...
    JSQMessage *videoMessage = [JSQMessage messageWithSenderId:kJSQDemoAvatarIdCook
                                                   displayName:kJSQDemoAvatarDisplayNameCook
                                                         media:videoItem];
